...
import org.spatial.crowdsource.service.WorkerService;
...
public class WorkerResourceIntTest {
    ...
    public void createWorker() throws Exception {
        ...
        assertThat(testWorker.getLocation()).isEqualTo(DEFAULT_LOCATION);
        assertThat(testWorker.getCapacity()).isEqualTo(DEFAULT_CAPACITY);
    }
    ...
    public void updateWorker() throws Exception {
        ...
        assertThat(testWorker.getLocation()).isEqualTo(UPDATED_LOCATION);
        assertThat(testWorker.getCapacity()).isEqualTo(UPDATED_CAPACITY);
    }
