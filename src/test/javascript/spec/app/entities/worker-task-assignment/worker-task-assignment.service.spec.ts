...
describe('Service Tests', () => {
    ...
    describe('WorkerTaskAssignment Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WorkerTaskAssignmentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/worker-task-assignments/' + 123);
            });
            it('should return WorkerTaskAssignment', () => {

                let entity: WorkerTaskAssignment;
                service.find(123).subscribe((_entity: WorkerTaskAssignment) => {
                    entity = _entity;
                });
